...
export function OrderTableRow({
  ...
  return (
    <TableRow className={isCompressed ? 'md:grid md:grid-cols-[1fr,auto]' : ''}>
      <TableCell className={`w-full ${isCompressed ? 'md:pr-8' : 'md:w-1/4'} min-w-[200px] text-base md:text-sm`}>
